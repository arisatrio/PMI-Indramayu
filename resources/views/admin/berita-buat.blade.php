            ...
            <div class="card-body">
                <div class="row">
                    <div class="row">
                        <div class="col mb-4">
                            <div class="d-sm-flex">
                                <h1 class="font-weight-bold">Buat Berita</h1>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <form method="POST" action="{{ route('admin.berita-baru-store') }}" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-md-8">
                        <input type="text" class="form-control mb-3 @error('judul_berita') is-invalid @enderror" id="judul_berita" name="judul_berita" placeholder="Masukkan Judul Berita">
                        @error('judul_berita')
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <textarea class="form-control @error('isi_berita') is-invalid @enderror" id="summernote" rows="20" name="isi_berita"></textarea>
                            @error('isi_berita')
                                <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        </div>
