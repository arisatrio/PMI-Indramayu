            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class=" col-md-2 nav-item dropdown">
                        <a class="nav-link dropdown-toggle text-muted" href="{{ route('admin.agenda-jadwal') }}" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            Agenda
                        </a>
