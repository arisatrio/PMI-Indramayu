    ...
    <div class="row mt-4 mb-4 pt-4 pb-4">
        ...
        <div class="col-sm-4">
            <div class="judul font-weight-bold" style="display: flex">
                <i class="far fa-hospital fa-2x mr-2" style="color: red; display: inline-block;"></i><h3>PROFIL</h3>
            </div>
            ...
            <nav class="nav flex-column">
                <a class="nav-link text-muted mb-2" data-toggle="collapse" href="#profil" role="button" aria-expanded="false" aria-controls="profil">
                    <i class="fa fa-angle-right mr-2"></i>Profil UDD PMI Kabupaten Indramayu
                </a>
        ...
        <div class="col-sm-8 bg-transparent">
            <div class="collapsed" id="profil" >
                <h4>Profil UDD PMI Kabupaten Indramayu</h4>
                <div class="bg-danger mt-2 mb-2" style="height: 2px; width: 35%; opacity: 0.5;"></div>
                <p style="text-align:justify">
                    Unit Donor Darah merupakan salah satu unit kerja yang ada di PMI Kabupaten Indramayu. Tugas dan fungsi utamanya ialah meningkatkan derajat kesehatan melalui pengelolaan darah yang berkualitas, mewujudkan pelayanan penyediaan darah yang aman, tepat waktu, terjangkau dan berkesinambungan.</p>
                    <p style="text-align:justify">
                    Keamanan dan mutu darah selalu diutamakan sehingga hanya di UDD PMI Kabupaten Indramayu yang telah melakukan pengujian darah paling lengkap dengan metode paling mutakhir baik terhadap infeksi menular lewat Donor darah, kelainan golongan darah pada pendonor dan untuk quality control (QC) produknya. Hampir semua peralatan yang digunakan dalam pengambilan, pengolahan, dan pengujian menggunakan mesin otomatisasi. UDD PMI Kabupaten Indramayu juga telah menggunakan sistem informasi sebagai penunjang pelayanan sejak tahun 2000 sampai dengan saat ini dengan berbagai pengembangannya yang dikenal dengan nama Sistem Informasi Donor Darah (SITD), yang juga terhubung dengan website UDD dan mesin-mesin pengujian dan pengolahan.</p>
                    <p style="text-align:justify">
                    UDD PMI Kabupaten Indramayu dengan 456 pegawai memberikan pelayanan donor darah dan pelayanan darah bagi pasien selama 24 jam tanpa henti ke beberapa Rumah Sakit yang ada diKabupaten Indramayu. Untuk mendekatkan pelayanan kepada masyarakat, telah dibuka UDD Cabang di PMIKabupaten Indramayu, PMI Kabupaten Indramayu yang beroperasional setiap harinya. Sedangkan di PMI Kabupaten Indramayu telah ada kegiatan donor darah walaupun belum setiap hari. UDD PMI Kabupaten Indramayu selain menerima donor darah di gedung PMI Kabupaten Indramayu juga memiliki armada Mobil Unit untuk melayani kegiatan donor darah yang diselenggarakan di instansi.
                </p>Indramayu
            ...
            <div class="collapse" id="moto">
                ...
                <div class="bg-danger mt-2 mb-2" style="height: 2px; width: 30%; opacity: 0.5;"></div>
                    ...
                    <p class="font-italic">“ UDD PMI Kabupaten Indramayumenjadi UDD paling terdepan tahun 2025 “</p>
            ...
            <div class="collapse" id="struktur">
                ...
                <p>
                    ...
                    <h6>Sesuai keputusan Pengurus Daerah PMI Kabupaten Indramayu No.104/KEP/PD.PMI//IX/2009 tentang organisasi dan tata kerja PMI Kabupaten Indramayu pasal 36, struktur di UDD PMI Kabupaten Indramayu terdiri dari :</h6>
                    1. Kepala Unit Donor Darah<br>
                    2. Wakil Kepala Unit Donor Darah<br>
